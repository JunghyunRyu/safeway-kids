...
export default function ProfileScreen() {
  const menuItems = [
    { icon: 'people' as const, label: '아이 관리', onPress: () => {} },
    { icon: 'card' as const, label: '결제 내역', onPress: () => {} },
    { icon: 'notifications' as const, label: '알림 설정', onPress: () => {} },
    { icon: 'shield-checkmark' as const, label: '개인정보 처리방침 (아동정보 보호)', onPress: () => {} },
    { icon: 'document-text' as const, label: '이용약관', onPress: () => {} },
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.name}>보호자</Text>
        <Text style={styles.role}>케어커넥트 보호자</Text>
      </View>
