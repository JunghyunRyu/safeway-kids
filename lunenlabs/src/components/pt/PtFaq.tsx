...
const faqs = [
  ...
  },
  {
    ...
    a: "가장 걱정되실 부분이라 별도 안전 인프라를 마련하고 있어요. (1) 산책 메이트 가입 시 신원조회·이력 검증·자기소개 자동 검수가 사전에 작동해요. (2) 산책 중에는 GPS 실시간 추적과 사고 자동 신고 AI가 즉시 알림을 보내드려요. (3) 책임 구조의 기본 원칙은 산책 메이트 1차 책임 + 플랫폼 보장 안전 인프라(보험·자문) 백업 형태이며, 보호자 과실(반려동물 기존 질환 미고지 등) 외 메이트 귀책 사고는 펫 산책 위탁 분야 단체보험으로 보장하는 구조를 V1.0 출시 시점(2026.06)에 약관·가맹 보험사와 함께 확정해서 안내드려요. (4) 사고·결제·보안 영역은 변호사·세무사·도메인 전문가의 자문을 받아 운영해요. 우리 아이를 처음 보는 사람에게 맡기는 부담을 최대한 낮추는 게 PT 운영의 1순위예요.",
  },
  {
    q: "결제는 언제부터 시작되나요?",
